...
- Следующий router command пока не выдаётся в этой синхронизации; после фиксации результата следующим отдельным шагом будет подготовка временного config для первого контролируемого кандидата.
